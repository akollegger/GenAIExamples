...
neo4j-grap-db
===============
Port 7474 - Open to 0.0.0.0/0
Port 7687 - Open to 0.0.0.0/0
...
```bash
docker build --no-cache -t opea/dataprep-neo4j:latest --build-arg https_proxy=$https_proxy --build-arg http_proxy=$http_proxy -f comps/dataprep/neo4j/langchain/Dockerfile .
cd ..
```
